...
3. **Click** a tile adjacent to the blank space, or use **Arrow Keys** to slide tiles
4. Arrange tiles **1 through 8** in order from top-left to bottom-right
5. Hit **Restart** to reset to the original board configuration at any time
6. On solving, submit your name to the **Leaderboard** 🏆
